...
const REQUIREMENTS := {
	"wine": "Вино: 200–250 мл, кружка 300 мл, бережливость ≤5 мл вне посуды.",
	"potato": "Картофель: 6 сторон, порция на тарелке.",
	"sausage": "Сосиска: покрытие ≥90%, порция на тарелке.",
