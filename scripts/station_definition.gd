...
const REQUIREMENTS := {"wine": "Вино: 200–250 мл в кружке 300 мл на подаче. Бережливость: не более 5 мл вне посуды; пролитое можно вернуть в кувшин.", "potato": "Картофель: 6 обжаренных сторон, подача на тарелке.", "sausage": "Сосиска: не менее 90% покрытия соусом, подача на тарелке.", "meal": "Стейк: обе стороны обжарены, соль ≥1 г. Макароны: вода ≥500 мл при варке, сварены и перемешаны, порция ≥100 г, соль ≥1 г. Две части на своих тарелках."}
