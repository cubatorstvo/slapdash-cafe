...
# Final event thresholds; economy and timing adjustments belong to the balance pass.
...
const FIRST_STAR_MANUAL_SERVED := 8
const FIRST_STAR_REWARD := 300
...
var inauguration_first_service_pending := false
