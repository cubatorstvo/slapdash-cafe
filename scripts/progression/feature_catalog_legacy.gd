...
const DEFINITIONS := {
	...
	"formula_research":{"id":"formula_research","title_key":"Исследование формулы","min_stars":2,"requires_features":["clone_lab"],"requires_milestones":["first_auto_served"],"unlock_rule_id":"always","sort_order":90,"announce":true},
	"clone_growth":{"id":"clone_growth","title_key":"Выращивание клонов","min_stars":1,"requires_features":["clone_lab"],"requires_milestones":["lab_assembled"],"unlock_rule_id":"always","sort_order":100,"announce":true},
	...
	"live_training":{"id":"live_training","title_key":"Личное обучение","min_stars":1,"requires_features":["production_tables"],"requires_milestones":["first_clone_created"],"unlock_rule_id":"always","sort_order":125,"announce":true},
	"video_recording":{"id":"video_recording","title_key":"Запись мастер-классов","min_stars":2,"requires_features":["live_training"],"requires_milestones":["first_live_lesson_accepted"],"unlock_rule_id":"always","sort_order":130,"announce":true},
	"video_training":{"id":"video_training","title_key":"Видеообучение","min_stars":2,"requires_features":["video_recording"],"requires_milestones":["first_masterclass_saved"],"unlock_rule_id":"always","sort_order":140,"announce":true},
	"group_training":{"id":"group_training","title_key":"Групповое обучение","min_stars":2,"requires_features":["video_training"],"requires_milestones":["first_video_training_completed","two_compatible_stations_seen"],"unlock_rule_id":"always","sort_order":150,"announce":true},
	...
	"formula_upgrades":{"id":"formula_upgrades","title_key":"Улучшения формулы","min_stars":2,"requires_features":["formula_research"],"requires_milestones":["first_auto_served"],"unlock_rule_id":"always","sort_order":180,"announce":true},
