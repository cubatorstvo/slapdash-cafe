...
s=s.replace('game.session.player_poses[7]={"position":[0,0.02,7]}','var remote_lab_position:=lab.operator_position()\n\tgame.session.player_poses[7]={"position":[remote_lab_position.x,remote_lab_position.y,remote_lab_position.z]}')
p.write_text(s)
