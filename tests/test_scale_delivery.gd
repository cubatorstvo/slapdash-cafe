...
func run()->void:
	...
	check(service._apply_group_plan(700,[2]).size()==1,"Source group stores the explicit desired potato plan")
	...
	print("7/8: v22 persists twenty-slot stations, explicit groups and unlearned lesson plans")
