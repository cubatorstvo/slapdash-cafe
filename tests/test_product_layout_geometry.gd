...
func run()->void:
	print("1/4: all twenty station footprints have product-scale breathing room")
	...
	print("2/4: main service aisles and the transverse aisle stay outside station footprints")
	...
	print("3/4: every slot footprint and working side is supported by its unlock-stage floor")
	for slot in range(Expansion.SLOT_COUNT):
	...
	print("4/4: staged entrances move forward with expansions and keep a useful lobby")
