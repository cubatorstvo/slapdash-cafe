...
func run()->void:
	...
	set_stage(game,4)
	await settle()
	await shot(game,"stage4-overview",Vector3(0,58,-54),Vector3(0,0,-8))
	await shot(game,"stage4-entrance",Vector3(0,3.0,-30.5),Vector3(0,1.5,8.0))
	await shot(game,"stage4-left",Vector3(-32,20,-8),Vector3(0,1,-8))
	await shot(game,"stage4-rear",Vector3(0,20,19.0),Vector3(0,1,-10))
