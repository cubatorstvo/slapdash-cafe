...
- **Лаборатория и комната отдыха — в заднем блоке.** Они остаются отдельными помещениями, но их двери подключены к той же читаемой магистрали.
...
- нейтральные центральные проходы оставлены доступными на всех стадиях, чтобы можно было свободно оценивать расстояния;
- полный лейтгейм-blockout занимает примерно **44 × 41 м**.
