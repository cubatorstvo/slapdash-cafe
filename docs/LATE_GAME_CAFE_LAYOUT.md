...
- Этап 1: центральная площадка Шефа, подход шириной 8 м и первая часть лаборатории 6 × 6 м. Доступная площадь пола — 212 м² вместо исходных 444 м².
...
### Вход на ранних этапах

На этапах 1–3 вход находится на передней границе зон A/B (Z = 2 м), примерно в 7 м от центра стойки Шефа. Центральный проход вдоль будущих C/D открывается вместе с ними на этапе 4; тогда вход переносится на Z = 16 м. Положение Шефа и уже открытых столов сохраняется. Входной проём, наружная дорожка, вывеска и точка возврата игрока переключаются вместе с этапом.
